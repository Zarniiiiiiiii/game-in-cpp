...
gl2d::Texture spaceShipTextures;
...
bool initGame()
{
	...
	spaceShipTextures.loadFromFile(RESOURCES_PATH "spaceShip/ships/green.png", true);
...
#pragma region movement 
	...
	if (move.x != 0 || move.y != 0)
	{
		...
		move *= deltaTime * 800; // 200 pixeli pe secunda
		data.playerPos += move;
	}
#pragma endregion
...
#pragma endregion
	...
	renderer.renderRectangle({data.playerPos, 200, 200}, spaceShipTextures);
